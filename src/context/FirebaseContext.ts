...
const firebaseErrorMessages: Record<string, string> = {
  ...
  "auth/uid-already-exists": "O indentificador fornecido já está em uso.",
...
export function getFirebaseErrorDescription(errorCode: string): string {
  return firebaseErrorMessages[errorCode] || "Erro ao realizar operação";
}
